...
void getTOTs (std::shared_ptr<std::vector<double>> input, double t20_div, double t30_div, 
    int &t20_b, int &t20_e, int &t30_b, int &t30_e,
    double max, std::vector<int> time);
